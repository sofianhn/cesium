...
function getImagePixels(image, width, height) {
  ...
  if (typeof document === "undefined") {
    if (typeof OffscreenCanvas !== "undefined") {
      ...
      const context2d2 = canvas.getContext("2d", { willReadFrequently: true });
      context2d2.globalCompositeOperation = "copy";
      context2d2.drawImage(image, 0, 0, width, height);
      return context2d2.getImageData(0, 0, width, height).data;
    }
    throw new Error(
...
function isCrossOriginUrlInWorker(url) {
  ...
  } else if (typeof self !== "undefined" && defined_default(self.location) && defined_default(self.location.href)) {
...
function getAuthority(url) {
  ...
  if (authority.indexOf(":") === -1) {
    ...
    if (scheme.length === 0) {
      if (typeof window !== "undefined" && defined_default(window.location)) {
...
// packages/engine/Source/Core/Resource.js
function getUrlApi() {
  if (typeof window !== "undefined" && defined_default(window.URL)) {
    return window.URL;
  }
  if (typeof self !== "undefined" && defined_default(self.URL)) {
    return self.URL;
  }
  return void 0;
}
...
Resource.prototype.fetchImage = function(options) {
  ...
  return Resource.supportsImageBitmapOptions().then(function(result) {
    ...
    const urlApi = getUrlApi();
    if (defined_default(urlApi) && defined_default(generatedBlobResource)) {
